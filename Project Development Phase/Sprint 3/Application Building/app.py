...
model = load_model('diabeticretino.h5')  # loading the model
...
def upload():
    if request.method == 'POST':
        ...
        img = image.load_img(filepath, target_size=(224,224))  # load and reshaping the image
        ...
        index = ['Normal', 'Stage 1: Mild Non Proliferative Diabetic Retinopathy ',
                 'Stage 2: Moderate Non Proliferative Diabetic Retinopathy', 'Stage 3: Severe Non Proliferative Diabetic Retinopathy', 'Stage 4: Proliferative Diabetic Retinopathy']
